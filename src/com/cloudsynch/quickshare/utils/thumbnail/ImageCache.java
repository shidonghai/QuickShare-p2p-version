 ...
 * {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to get an
...
public class ImageCache {
	...
	public BitmapDrawable getBitmapFromMemCache(String data) {
		...
		if (LogUtil.DEBUG && memValue != null) {
